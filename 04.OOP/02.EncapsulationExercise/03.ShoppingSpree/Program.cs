namespace _03.ShoppingSpree
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            var peopleData = Console.ReadLine().Split(separators, StringSplitOptions.RemoveEmptyEntries);
            var productData = Console.ReadLine().Split(separators, StringSplitOptions.RemoveEmptyEntries);
